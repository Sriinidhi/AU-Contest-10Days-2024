Given an array of integers, your task is to segregate the even and odd numbers. The even numbers should come first, followed by the odd numbers, while maintaining the relative order within each group.
